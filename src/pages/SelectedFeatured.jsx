...
<div className='w-[300px] flex  flex-col  items-center   px-2 h-[500px] bg-green-600'>
...
<img src={g.imageUrl}/>
        ...
        <p className=" text-[15px] Laato left-3   text-gray-500 px-10 ">Updated on {moment(g.publishedAt).format('dddd, MMMM Do YYYY')}</p>
        <p>
          {g.body}
        </p>
</div>
