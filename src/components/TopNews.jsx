...
<div className='h-auto'>
       ...
       <div className='  lg:h-[120px] bg-white relative shadow-md hover:shadow-xl hover:transform hover:scale-100 duration-300 rounded-md w-full px-2 flex justify-between flex-row md:px-10 py-4'>

<div className='w-full flex flex-col justify-between h-full '>
<h1 className='text-[#212121] text-base  Hd sm:text-[15px] md:text-lg  md:Laato'>{displayText}</h1>
<p className=" text-[15px]  w-full     Hd text-gray-400 font-thin px-10 ">Updated on {moment(f.publishedAt).format('dddd, MMMM Do YYYY')}</p>
</div>
